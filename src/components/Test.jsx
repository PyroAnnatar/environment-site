...
const Test = ({ test, testy }) => {
  return (
    <button
      onClick={testy}
      className="absolute bottom-4 right-4 font-semibold text-red-600 bg-black p-2 rounded-full border-4 shadow-[0_0_10px_rgba(255,255,255,0.3)_inset] border-zinc-900 hover:bg-[#0a0a0a] transition-all duration-75 active:bg-[#18181b] active:shadow-[0_0_10px_rgba(0,0,0,1)_inset] group"
    >
